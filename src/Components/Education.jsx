    ...
    <div className="min-h-screen">
      ...
      <div className="p-4">
        ...
        <p className="text-justify my-4">
          ...
          enjoy different advice on a variety of educational needs and services.
          This could mean reviewing new educational tools or working closely
          with parents to ensure that they know how to support their students as
          they apply to and plan for college. We provide guidance and support to
          students, parents, and schools related to education and career
