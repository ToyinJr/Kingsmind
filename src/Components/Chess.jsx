...
const offerings = [
  { icon: "fa-school", label: "Chess in Schools", desc: "Structured programs bringing chess into classrooms." },
  { icon: "fa-people-group", label: "Chess Clubs", desc: "Regular club sessions for all skill levels." },
  { icon: "fa-house", label: "Private Home Tutoring", desc: "One-on-one coaching at your convenience." },
  { icon: "fa-laptop", label: "Online Chess Training", desc: "Remote sessions from anywhere in the world." },
  { icon: "fa-trophy", label: "Chess Competitions", desc: "Scholastic tournaments and recreational events." },
];
...
const Chess = () => {
  ...
  return (
    <>
      <Helmet><title>KingsMind Chess</title></Helmet>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        {/* ── Contact CTA ── */}
        <div className="mx-5 sm:mx-8 lg:mx-16 mb-12 max-w-4xl lg:mx-auto rounded-2xl overflow-hidden
          ...
          <p className="text-white/80 mb-5 text-sm sm:text-base">
            For competitions, fun, or training — contact Mr. Joseph Agoro directly on WhatsApp.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link to="http://wa.me/+2348029726732" target="_blank"
            ...
            <Link to="http://wa.me/+2348115087637" target="_blank"
                  className="flex items-center gap-2 bg-white/15 hover:bg-white/25
                             transition-colors px-5 py-3 rounded-xl font-semibold text-sm">
              <i className="fa-brands fa-whatsapp text-2xl" aria-hidden="true" />
              +234 811 508 7637
