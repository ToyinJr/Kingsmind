      ...
      <div className="p-4">
        <div className="space-y-4 md:p-14 md:text-xl">
          <p className="md:text-justify">
            ...
            of children at different levels. Often from their kindergarten age
            to adulthood. Some of the members of our team enjoyed Mr. Joseph's
          ...
          <p className="md:text-justify">
            ...
            hardwork, perseverance have gotten really better and far ahead of
            our mates in the business of mentoring and shaping lives.
          </p>
