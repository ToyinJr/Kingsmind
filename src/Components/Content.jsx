...
const Content = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      {/* ── Swiper Slideshow ── */}
      <div className="swiper w-full" style={{ height: "clamp(260px, 70svh, 850px)" }}>
        <div className="swiper-wrapper">
          {images.map((src, index) => (
            <div className="swiper-slide" key={index}>
              <img
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {cards.map((card, j) => (
            ...
            >
              ...
              <div className="w-full overflow-hidden" style={{ height: "clamp(180px, 30vw, 320px)" }}>
                <img
                  src={card.image}
                  alt={card.alt}
              ...
              <div className="flex flex-col flex-1 p-5 gap-4">
                <h2 className="font-bold text-center leading-tight"
